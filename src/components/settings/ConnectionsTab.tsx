...
const serviceConfig: ProviderMeta[] = [
  ...
  { id: 'anthropic', balanceKey: 'anthropic', name: 'Claude AI (Anthropic)', desc: 'כתיבת תסריטים, שיפור פרומפטים, ניתוח תוכן, טרנדים', icon: Sparkles, free: false, plan: 'API מחובר',
    hasCredits: false, role: 'ברירת מחדל', category: 'AI / תסריטים / ניתוח', safeForGeneration: true, blockedManually: false, requiresApproval: false, noAutoGeneration: true,
    billingType: 'תשלום לפי tokens', monthlyCost: 'משתנה', extraCreditsNeeded: false, costConfirmed: true },
  { id: 'perplexity', balanceKey: 'perplexity', name: 'Perplexity AI', desc: 'ניתוח טרנדים ויראליים בזמן אמת', icon: Zap, free: false, plan: 'API מחובר',
    hasCredits: false, role: 'לא פעיל', category: 'ניתוח טרנדים', safeForGeneration: false, blockedManually: true, requiresApproval: false, noAutoGeneration: true,
    billingType: 'הוחלף על ידי Claude AI', monthlyCost: '$0', extraCreditsNeeded: false, costConfirmed: true },
